                            ...
                            $var->the_post(); ?>
                                ...
                                <div class="dados">
                                    <div class="telefones">
                                        ...
                                        <?php if ($whatsapp != '') { ?> 
                                             <a class="whatsapp" href="https://api.whatsapp.com/send?phone=55<?php echo $whatsapp ?>&text=Olá, vim pelo site do Cleem" alt="<?php echo $whatsapp ?>" title="<?php echo $whatsapp ?>1" target="_blank">
